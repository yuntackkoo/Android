        ...
        if (chr == null) {
            if (mDefaultChar == null) {
                ...
                if (isWritableCharacteristic(mDefaultChar)) {
                    Log.d("checkGattServices", "# Default GattCharacteristic is PROPERY_WRITE | PROPERTY_WRITE_NO_RESPONSE");
                    writableChar = mDefaultChar;
                } else {
                    Log.d("checkGattServices", "# Default GattCharacteristic is not writable");
                    mDefaultChar = null;
                    return false;
                }
            }
            ...
            if (isWritableCharacteristic(chr)) {
                Log.d("checkGattServices", "# user GattCharacteristic is PROPERY_WRITE | PROPERTY_WRITE_NO_RESPONSE");
                writableChar = chr;
            } else {
                Log.d("checkGattServices", "# user GattCharacteristic is not writable");
                return false;
            }
        }
